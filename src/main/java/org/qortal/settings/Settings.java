...
public class Settings {
    ...
    public static void fileInstance(String filename) {
        ...
        fileInstance(filename, doChain);
    }

    public static void fileInstance(String filename, boolean doChain) {
        JAXBContext jc;
...
////		Field[] gottenFields = this.getClass().getFields();
//        Field[] gottenFields = this.getClass().getFields();
//
//        for (final Field field : gottenFields) {
...
//    }
    ...
    public Method[] getDeclaredMethodsList() {
        return this.getClass().getDeclaredMethods();
//		return this.getClass().getDeclaredMethods0();
    }


    public Field[] getDeclaredFieldsList() {
